...
app.use(cors()); //Instalei o cors no terminal e executo neste arquivo para que o backend se integre com o frontend
...
const PORT = process.env.PORT || 3333; //definindo minha porta //ESTE É O INÍCIO DO ENDEREÇO (1).
